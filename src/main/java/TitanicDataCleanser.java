...
class TitanicDataCleanser {
    ...
    public double[][][] prepTrainingData() {
        ...
        try {
            ...
            BufferedReader br = new BufferedReader(new FileReader(System.getProperty("user.dir") + "/src/main/data/train.csv"));
            if(br.ready()) {
                br.readLine();
            ...
            br = new BufferedReader(new FileReader(System.getProperty("user.dir") + "/src/main/data/train.csv"));
            if(br.ready()) {
                br.readLine();
    ...
    public double[][][] prepTestingData() {
        ...
        try {
            ...
            BufferedReader br = new BufferedReader(new FileReader(System.getProperty("user.dir") + "/src/main/data/test.csv"));
            if(br.ready()) {
                br.readLine();
                while((line = br.readLine()) != null) {                           
                    ArrayList<String> line_raw = new ArrayList<String>(Arrays.asList(line.split(",(?=([^\"]*\"[^\"]*\")*[^\"]*$)")));
            ...
            /* NORTMALIZE AGE AND REPLACE MISSING VALUES WITH AVERAGE DEPEDNING ON MALE OR FEMALE */
            br = new BufferedReader(new FileReader(System.getProperty("user.dir") + "/src/main/data/test.csv"));
            if(br.ready()) {
                br.readLine();
                for(int i = 0; i < age_denormalized.size(); i++) {
                    line = br.readLine();
            ...
            br = new BufferedReader(new FileReader(System.getProperty("user.dir") + "/src/main/data/genderclassmodel.csv"));
            if(br.ready()) {
                int index = 0;
                br.readLine();
                while((line = br.readLine()) != null) {
